...
*Комментарий:* выписку из зачётной книжки, заверенной в деканате (выписка из зачётно-экзаменационной ведомости) можно заказать через [личный кабинет студента РЭУ][9] в разделе "Справки" / "Заказ документов".
